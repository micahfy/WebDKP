...
if not AceLibrary then
    AceLibrary = {
        libs = {},
        Register = function(self, lib, major, minor)
            self.libs[major] = lib
        end,
        HasInstance = function(self, major)
            return self.libs[major] ~= nil or major == "AceLocale-2.2"
        end,
        IsNewVersion = function(self, major, minor)
            return true
        end
    }
    
    local AceLocale = {
        GetLibraryVersion = function() return "AceLocale-2.2", 1 end,
        new = function(self, major)
            local instance = {
                RegisterTranslations = function(inst, locale, func)
                    local data = func()
                ...
                Debug = function() end,
                SetStrictness = function() end,
                HasTranslation = function(inst, text)
                    return inst[text] ~= nil
                end,
                HasReverseTranslation = function(inst, text)
                    for k, v in pairs(inst) do
                        if type(k) == "string" and type(v) == "string" and (v == text or k == text) then
                            return true
                        end
                    end
                    return false
                end,
                GetReverseTranslation = function(inst, text)
                    for k, v in pairs(inst) do
                        if type(k) == "string" and type(v) == "string" and v == text then
                            return k
                        end
                    end
                    return text
            ...
            _G["BabbleBoss"] = instance
            return instance
        end
    }
    
    setmetatable(AceLibrary, {
        __call = function(t, major)
            if major == "AceLocale-2.2" then
                return AceLocale
            elseif major == "Babble-Boss-2.2" then
                return _G["BabbleBoss"]
            end
        end
    })
end
...
local MINOR_VERSION = 20008 -- 佚名: added BigWigs-New Turtle boss names, 2026-04-25
...
BabbleBoss:RegisterTranslations("enUS", function()
	return {
		...
		-- 佚名: BigWigs-New boss names, 2026-04-25
		["Incindis"] = true,
		...
		["Gargoyle"] = true,
		["Solnius"] = true,       --世界Boss
		["Deathknight Captain"] = true,       --纳克萨玛斯
		["Unstoppable Abomination"] = true,       --纳克萨玛斯
		["Soul Weaver"] = true,        --纳克萨玛斯
		...
		["Flesh Hunter"] = true,        --AQ40
		["Qiraji Champion"] = true,        --AQ40
		["Qiraji Mindslayer"] = true,        --AQ40
		["Qiraji Brainwasher"] = true,        --AQ40
		["Sanctum Dragonkin"] = true,       --翡翠圣殿
		["Sanctum Dreamer"] = true,       --翡翠圣殿
		["Sanctum Supressor"] = true,       --翡翠圣殿
		["Sanctum Wyrmkin"] = true,       --翡翠圣殿
		["Sanctum Wyrm"] = true,       --翡翠圣殿
		["Skitterweb Egg"] = true,       --卡拉赞，巢穴女王阿拉克萨娜
		["Phantom Servant"] = true,       --卡拉赞
		["Dark Rider Champion"] = true,       --卡拉赞
		["Gurubashi Bat Rider"] = true,        --祖格
		["Zealot Zath"] = true,        --祖格
		["Zealot Lor'Khan"] = true,        --祖格
		["Shade of Jin'do"] = true,        --祖格
		["Spawn of Mar'li"] = true,       --祖格
		["Chromatic Elite Guard"] = true,      --黑石塔
		["Death Talon Wyrmguard"] = true,      --黑石塔
		["Blackhand Incarcerator"] = true,      --黑石塔
		["Rookery Hatcher"] = true,      --黑石塔
		["Rookery Guardian"] = true,      --黑石塔
		["Drek'Thar"] = true,       --战场
		["Vanndar Stormpike"] = true,       --战场
...
BabbleBoss:RegisterTranslations("esES", function()
	return {
		...
		["Blackwing Guardsman"] = "Blackwing Guardsman",
		["Patchwerk"] = "Remendejo",
		["Grobbulus"] = "Grobbulus",
		["Gluth"] = "Gluth",
		["Feugen"] = "Feugen",
...
BabbleBoss:RegisterTranslations("ruRU", function()
	return {
		...
		["Blackwing Guardsman"] = "Чёрный страж",
		["Patchwerk"] = "Лоскутик",
		["Grobbulus"] = "Гроббулус",
		["Gluth"] = "Глут",
		["Feugen"] = "Фойген",
